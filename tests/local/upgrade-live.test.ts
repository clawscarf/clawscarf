...
import { z } from "zod";
import { readState, resourceNames } from "../../scripts/local/state.js";
import { readUpgrade } from "../../scripts/local/upgrade-state.js";
import { upgradeLocal } from "../../scripts/local/upgrade.js";
import { verifyRuntimeBinding } from "../../scripts/local/runtime-binding.js";
import { runtimeManager } from "../../scripts/local/runtime.js";
...
await test(
  ...
  async () => {
    ...
    const child = `
    import { upgradeLocal } from './scripts/local/upgrade.ts';
    import { run } from './scripts/local/process.ts';
