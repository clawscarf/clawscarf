...
contract or a second task list. The [product README](../README.md) owns current
...
[component manifest](../release/components.json). Upstream links below point to
...
The [existing trust boundary](../README.md#what-it-contains) remains: Gateway,
...
The [ClawScarf preset](configuration.ts) is applied on initial configuration;
...
[image assembly](../deploy/images/Dockerfile) adds its own native plugins and
...
- ClawScarf's [browser enrollment](../deploy/execution/browser-node/operator.ts)
...
Use the existing separation between [runtime releases](../release/README.md),
[recipes](../recipes/README.md) and [packs](../packs/README.md). A recipe pins a
...
[image capability evidence](../deploy/images/README.md#verified-limits) and the
[runtime verification](../README.md#current-verification-and-limits) own what has
...
described in the [runtime guide](README.md).
